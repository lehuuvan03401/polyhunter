        ...
        <div className="relative" ref={menuRef}>
            ...
            {isOpen && (
                <div className="absolute right-0 mt-2 w-64 rounded-xl border border-[#2c2d33] bg-[#1a1b1e] shadow-xl z-50 overflow-hidden animate-in fade-in zoom-in-95 duration-100">
                    ...
                    <div className="p-1">
                        <Link href="/affiliate?tab=account" className="flex items-center gap-3 px-3 py-2 text-sm text-gray-300 hover:text-white hover:bg-white/5 rounded-lg transition-colors">
