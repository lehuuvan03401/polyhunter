...
const TIERS = [
    { name: 'ORDINARY', icon: Users, color: 'text-gray-400', bg: 'bg-gray-500/10', border: 'border-gray-500/30', directsRequired: 0, teamRequired: 0, teamDiff: 1 },
    { name: 'VIP', icon: Star, color: 'text-blue-400', bg: 'bg-blue-500/10', border: 'border-blue-500/30', directsRequired: 3, teamRequired: 10, teamDiff: 2 },
    { name: 'ELITE', icon: Trophy, color: 'text-purple-400', bg: 'bg-purple-500/10', border: 'border-purple-500/30', directsRequired: 10, teamRequired: 100, teamDiff: 3 },
    { name: 'PARTNER', icon: Crown, color: 'text-yellow-400', bg: 'bg-yellow-500/10', border: 'border-yellow-500/30', directsRequired: 30, teamRequired: 500, teamDiff: 5 },
    { name: 'SUPER_PARTNER', icon: Gem, color: 'text-orange-400', bg: 'bg-orange-500/10', border: 'border-orange-500/30', directsRequired: 50, teamRequired: 1000, teamDiff: 8 },
];
...
export function AffiliateRulesTab({ currentTier = 'ORDINARY', className }: AffiliateRulesTabProps) {
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    <div className="space-y-4">
                        ...
                        <div className="bg-white/5 rounded-lg p-4 space-y-2">
                            <div className="text-sm font-medium text-yellow-400">{t('sunLine.formulaLabel')}</div>
