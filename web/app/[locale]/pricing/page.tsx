...
function AuthenticatedPricing() {
    ...
    const t = useTranslations('Pricing.Authenticated');
        ...
        <div className="min-h-screen pt-24 pb-20 px-4">
            ...
            <div className="container max-w-6xl mx-auto mb-16 text-center space-y-4">
                ...
                <p className="text-lg text-muted-foreground">
                    {isLoading ? t('loading') : t('volume', { volume: formatVolume(userVolume || 0) })}
                </p>
            </div>
            ...
            <div className="container max-w-6xl mx-auto mb-8">
                <div className="bg-gradient-to-r from-blue-900/30 to-purple-900/30 border border-blue-500/30 rounded-xl p-6 flex flex-col md:flex-row items-center justify-between gap-4">
                    <div>
                        <h3 className="text-lg font-bold text-white mb-1">{t('proxy.title')}</h3>
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    ...
                    <div className="rounded-2xl border border-[#2c2d33] bg-[#1a1b1e] p-8 flex flex-col relative overflow-hidden ring-1 ring-white/5">
                        <div className="mb-8 text-center">
                            <h3 className="text-2xl font-bold mb-2 text-white">{t('tiers.starter.name')}</h3>
                            <p className="text-muted-foreground text-sm">{t('tiers.starter.desc')}</p>
                        </div>

                        <div className="flex-1 flex flex-col items-center justify-center py-6 space-y-2">
                            <div className="text-xs font-medium text-muted-foreground mb-4">{t('tiers.shareOfProfits')}</div>
                            ...
                            <div className="text-[10px] text-muted-foreground flex gap-4 uppercase tracking-wider font-medium">
                                <span className="flex items-center gap-1.5"><div className="w-2 h-2 rounded-full bg-green-500" /> {t('tiers.youKeep')}</span>
                                <span className="flex items-center gap-1.5"><div className="w-2 h-2 rounded-full bg-white/20" /> {t('tiers.fee')}</span>
                            </div>
                        </div>

                        <div className="text-center mb-8 py-6 border-y border-white/5 bg-black/20 -mx-8 px-8">
                            <div className="text-3xl font-bold text-white mb-1">{t('tiers.starter.fee')}</div>
                            <div className="text-xs text-muted-foreground uppercase tracking-wider">{t('tiers.onRealizedProfits')}</div>
                        </div>

                        <div className="space-y-6 mb-8">
                            <div className="flex justify-between items-center text-sm p-4 rounded-xl bg-black/20 border border-white/5">
                                <span className="text-muted-foreground">{t('tiers.executionSpeed')}</span>
                                <div className="flex items-center gap-3">
                                    <SignalBars level={1} />
                                    <span className="font-medium text-white">{t('tiers.speeds.standard')}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <button className={cn(
                            ...
                            {currentTier === 'starter' ? (
                                <><Check className="h-5 w-5" /> {t('tiers.current')}</>
                            ) : (
                                t('tiers.starter.button')
                            )}
                        </button>
                    </div>
                    ...
                    <div className="rounded-2xl border border-[#2c2d33] bg-[#1a1b1e] p-8 flex flex-col relative overflow-hidden group hover:border-blue-500/30 transition-all">
                        <div className="mb-8 text-center">
                            <h3 className="text-2xl font-bold mb-2 text-white">{t('tiers.pro.name')}</h3>
                            <p className="text-muted-foreground text-sm font-medium">{t('tiers.pro.desc')}</p>
                        </div>
                        ...
                        <div className="text-center mb-8 py-6 border-y border-white/5 bg-black/20 -mx-8 px-8">
                            <div className="text-3xl font-bold text-blue-400 mb-1">{t('tiers.pro.fee')}</div>
                            <div className="text-xs text-muted-foreground uppercase tracking-wider">{t('tiers.onRealizedProfits')}</div>
                        </div>
                        ...
                        <div className="space-y-4 mb-8">
                            <div className="flex justify-between items-center text-sm p-4 rounded-xl bg-black/20 border border-white/5">
                                ...
                                <div className="flex items-center gap-3">
                                    <SignalBars level={2} />
                                    <span className="font-medium text-white">{t('tiers.speeds.fast')}</span>
                                </div>
                            </div>
                            ...
                            <div className="bg-black/40 rounded-xl p-4 border border-white/5">
                                <div className="flex justify-between text-xs mb-2 text-muted-foreground">
                                    <span>{t('tiers.volumeProgress')}</span>
                        ...
                        <button className={cn(
                            ...
                            {currentTier === 'pro' ? (
                                ...
                                t('tiers.unlock', { amount: formatVolume(PRO_THRESHOLD - (userVolume || 0)) })
                            )}
                        </button>
                    </div>
                    ...
                    <div className="rounded-2xl border border-yellow-500/30 bg-[#1a1b1e] p-8 flex flex-col relative overflow-hidden group hover:border-yellow-500/60 transition-all shadow-lg shadow-yellow-500/5">
                        <div className="absolute top-0 transform -translate-x-1/2 left-1/2 bg-yellow-500 text-black text-[10px] font-bold px-3 py-1 rounded-b-lg flex items-center gap-1 uppercase tracking-wider shadow-lg">
                            <Crown className="h-3 w-3" /> {t('tiers.whale.badge')}
                        </div>

                        <div className="mb-8 text-center pt-4">
                            <h3 className="text-2xl font-bold mb-2 text-white">{t('tiers.whale.name')}</h3>
                            <p className="text-muted-foreground text-sm font-medium">{t('tiers.whale.desc')}</p>
                        </div>
                        ...
                        <div className="text-center mb-8 py-6 border-y border-white/5 bg-black/20 -mx-8 px-8">
                            <div className="text-3xl font-bold text-yellow-500 mb-1">{t('tiers.whale.fee')}</div>
                            <div className="text-xs text-muted-foreground uppercase tracking-wider">{t('tiers.onRealizedProfits')}</div>
                        </div>
                        ...
                        <div className="space-y-4 mb-8">
                            <div className="flex justify-between items-center text-sm p-4 rounded-xl bg-black/20 border border-white/5">
                                ...
                                <div className="flex items-center gap-3">
                                    <SignalBars level={3} />
                                    <span className="font-medium text-white">{t('tiers.speeds.instant')}</span>
                                </div>
                            </div>
                        ...
                        <button className={cn(
                            ...
                            {currentTier === 'whale' ? (
                                ...
                                t('tiers.unlock', { amount: formatVolume(WHALE_THRESHOLD - (userVolume || 0)) })
                            )}
                        </button>
                    </div>
                </div>
...
function PublicPricing() {
    ...
    const t = useTranslations('Pricing.Public');
        ...
        <div className="flex flex-col min-h-screen">
            ...
            <section className="py-12 px-4">
                <div className="container max-w-5xl mx-auto">
                    <div className="bg-card/50 border border-white/5 rounded-2xl p-8 md:p-12 relative overflow-hidden">
                        ...
                        <h2 className="text-center text-xl font-semibold mb-12">{t('howItWorks.title')}</h2>

                        <div className="grid md:grid-cols-3 gap-8 relative z-10">
                            {[
                                { icon: Rocket, title: t('howItWorks.step1.title'), desc: t('howItWorks.step1.desc') },
                                { icon: Zap, title: t('howItWorks.step2.title'), desc: t('howItWorks.step2.desc') },
                                { icon: Crown, title: t('howItWorks.step3.title'), desc: t('howItWorks.step3.desc') }
                            ].map((step, i) => (
                ...
                <div className="container max-w-6xl mx-auto">
                    <div className="grid md:grid-cols-3 gap-8">
                        ...
                        <div className="rounded-2xl border border-white/10 bg-card p-8 flex flex-col relative overflow-hidden group hover:border-white/20 transition-all">
                            <div className="mb-8">
                                <h3 className="text-2xl font-bold mb-2">{t('tiers.starter.name')}</h3>
                                <p className="text-muted-foreground text-sm">{t('tiers.starter.desc')}</p>
                            </div>
                            ...
                            <div className="flex-1 flex flex-col items-center justify-center py-8 space-y-2">
                                ...
                                <div className="text-xs text-muted-foreground flex gap-4">
                                    <span className="flex items-center gap-1"><div className="w-2 h-2 rounded-full bg-green-500" /> {useTranslations('Pricing.Authenticated')('tiers.youKeep')}</span>
                                    <span className="flex items-center gap-1"><div className="w-2 h-2 rounded-full bg-white/20" /> {useTranslations('Pricing.Authenticated')('tiers.fee')}</span>
                                </div>
                            </div>

                            <div className="text-center mb-8">
                                <div className="text-4xl font-bold text-blue-400">{t('tiers.starter.fee')}</div>
                                <div className="text-xs text-muted-foreground">{t('tiers.starter.details')}</div>
                            </div>

                            <div className="space-y-4 mb-8">
                                <div className="flex justify-between text-sm py-2 border-b border-white/5">
                                    <span className="text-muted-foreground">{t('tiers.executionSpeed')}</span>
                                    <span className="font-medium">{useTranslations('Pricing.Authenticated')('tiers.speeds.standard')}</span>
                                </div>
                            </div>
                            ...
                            >
                                {isLoggingIn ? (
                                    <>
                                        {t('tiers.button.connecting')}
                                        <Loader2 className="h-4 w-4 animate-spin" />
                                    </>
                                ) : (
                                    t('tiers.button.start')
                                )}
                            </button>
                        </div>
                        ...
                        <div className="rounded-2xl border border-white/10 bg-card p-8 flex flex-col relative overflow-hidden group hover:border-blue-500/50 transition-all">
                            <div className="mb-8">
                                <h3 className="text-2xl font-bold mb-2 text-white">{t('tiers.pro.name')}</h3>
                                <p className="text-blue-400 text-sm font-medium">{t('tiers.pro.desc')}</p>
                            </div>
                            ...
                            <div className="text-center mb-8">
                                <div className="text-4xl font-bold text-blue-400">{t('tiers.pro.fee')}</div>
                                <div className="text-xs text-muted-foreground">{t('tiers.pro.details')}</div>
                            </div>

                            <div className="space-y-4 mb-8">
                                <div className="flex justify-between text-sm py-2 border-b border-white/5">
                                    <span className="text-muted-foreground">{t('tiers.executionSpeed')}</span>
                                    <span className="font-medium flex items-center gap-1 text-blue-400"><Zap className="h-3 w-3" /> {useTranslations('Pricing.Authenticated')('tiers.speeds.fast')}</span>
                                </div>
                            </div>
                        ...
                        <div className="rounded-2xl border border-yellow-500/30 bg-card p-8 flex flex-col relative overflow-hidden group hover:border-yellow-500/60 transition-all shadow-[0_0_40px_-10px_rgba(234,179,8,0.1)]">
                            ...
                            <div className="mb-8">
                                <h3 className="text-2xl font-bold mb-2 text-yellow-500">{t('tiers.whale.name')}</h3>
                                <p className="text-yellow-500/80 text-sm font-medium">{t('tiers.whale.desc')}</p>
                            </div>
                            ...
                            <div className="text-center mb-8">
                                <div className="text-4xl font-bold text-yellow-500">{t('tiers.whale.fee')}</div>
                                <div className="text-xs text-muted-foreground">{t('tiers.whale.details')}</div>
                            </div>

                            <div className="space-y-4 mb-8">
                                <div className="flex justify-between text-sm py-2 border-b border-white/5">
                                    <span className="text-muted-foreground">{t('tiers.executionSpeed')}</span>
                                    <span className="font-medium flex items-center gap-1 text-yellow-500"><Rocket className="h-3 w-3" /> {useTranslations('Pricing.Authenticated')('tiers.speeds.instant')}</span>
                                </div>
                            </div>
                    ...
                    <div className="mt-16 text-center">
                        <h3 className="text-lg font-medium mb-8">{t('features.title')}</h3>
                        <div className="flex flex-wrap justify-center gap-8">
                            {[
                                t('features.list.unlimited'),
                                t('features.list.gas'),
                                t('features.list.realTime'),
                                t('features.list.noFees')
                            ].map((feat, i) => (
            ...
            <section className="py-24 px-4 text-center border-t border-white/5 mt-auto">
                <div className="container max-w-3xl mx-auto space-y-6">
                    <h2 className="text-3xl font-bold">{t('footer.title')}</h2>
