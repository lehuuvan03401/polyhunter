...
- `COPY_TRADING_SPEED_MODE` / `COPY_TRADING_SPEED_PROFILE`
- `COPY_TRADING_MAX_SPREAD_BPS` / `COPY_TRADING_MIN_DEPTH_USD`
- `COPY_TRADING_MIN_DEPTH_RATIO` / `COPY_TRADING_DEPTH_LEVELS`

Speed mode (one-click):
