        ...
        <div className="bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20 rounded-xl overflow-hidden">
            ...
            <div className="p-4 flex items-center justify-between bg-blue-500/5">
                <div className="flex items-center gap-3">
                    ...
                    <div>
                        <h3 className="font-semibold text-white">Pending Copy Trades</h3>
                        <p className="text-xs text-muted-foreground">
                            {pendingTrades.length} trade{pendingTrades.length > 1 ? 's' : ''} waiting for confirmation
                        </p>
                    </div>
                </div>
                <button
                        ...
                        {expandedTrade === trade.id && (
                            <div className="mt-4 pt-4 border-t border-white/5">
                                <div className="grid grid-cols-2 gap-4 mb-4 text-sm">
                                    <div>
                                        <span className="text-muted-foreground">Original Trade:</span>
