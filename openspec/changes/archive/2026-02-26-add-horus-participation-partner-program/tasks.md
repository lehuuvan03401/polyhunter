...
- [x] 8.2 Add integration tests for activation, referral bonus one-time guard, and partner elimination/refund workflow.
- [x] 8.3 Add E2E flows for FREE vs MANAGED onboarding and partner-seat operations.
